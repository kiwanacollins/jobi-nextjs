            ...
            <div className="col-lg-8">
              <div className="blog-details-page pe-xxl-5 me-xxl-3">
                <article className="blog-details-meta">
                  ...
                  <div className="img-meta mb-15">
                    <Image src={img_2} alt="blog-img" className="lazy-img" />
                  </div>
                  <h5>
                  ...
                  <div className="quote-text">
                    <div className="row">
                      <div className="col-xl-10 m-auto">
                        ...
                        <div className="name">
                          <span className="fw-500">Brian Reed, </span>
                  ...
                  <p>
                    ...
                    of wlir ext quiert all kinds, including the most common of
                    all.
                  </p>
